...
package gradle.kotlin.dsl.plugins._823b7e44fcf0f90ba19c010563cb7527
...
/**
 * The `io.github.merseyside` plugin group.
 */
@org.gradle.api.Generated
internal
class `IoGithubMerseysidePluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `io.github.merseyside`.
 */
internal
val `IoGithubPluginGroup`.`merseyside`: `IoGithubMerseysidePluginGroup`
    get() = `IoGithubMerseysidePluginGroup`(plugins)


/**
 * The `io.github.merseyside.android-extension` plugin implemented by [com.merseyside.gradle.plugin.android.AndroidExtensionPlugin].
 */
internal
val `IoGithubMerseysidePluginGroup`.`android-extension`: PluginDependencySpec
    get() = plugins.id("io.github.merseyside.android-extension")


/**
 * The `io.github.merseyside.kotlin-extension` plugin implemented by [com.merseyside.gradle.plugin.KotlinExtensionPlugin].
 */
internal
val `IoGithubMerseysidePluginGroup`.`kotlin-extension`: PluginDependencySpec
    get() = plugins.id("io.github.merseyside.kotlin-extension")
